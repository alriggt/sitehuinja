					...
					<div className="footerContainer">
						...
						<div className="footerContainer-1">
							...
							<ul className="footerNav">
								...
								<li><a href="#">{t("footer.links.news")}</a></li>
						...
						<div className="footerContainer-1">
							<div className="footerMainText">{t("footer.usefulLinks")}</div>
							<ul className="footerNav">
								<li><a href="#">{t("footer.links.inst")}</a></li>
								<li><a href="#">{t("footer.links.aboutStore")}</a></li>
								<li><a href="#">{t("footer.links.contact")}</a></li>
						...
						<div className="footerContainer-1">
							<div className="footerTextAbout">{t("footer.aboutStore")}</div>
							<div className="footerText">{t("about.description.tab3")}</div>
